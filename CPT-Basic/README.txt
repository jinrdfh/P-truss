This project is the algorithm about "CPT-Basic", written in C++.
...
The file "CPT-Basic.out" generated is the program file.
The version of g++ is "gcc version 4.4.7 20120313 (Red Hat 4.4.7-23) (GCC)".

######run
You can copy "CPT-Basic.out" to "/" folder and run it.
Here is the command:
./CPT-Basic.out ${dataFile} ${resultPath} ${dataLabel}

For example, if we enter the follow command:
./CPT-Basic.out ./datasets/Fruit-Fly.txt ./index/CPT-Basic/ CPT-Basic-Fruit-Fly
